...
const steps = [
  {
    ...
    description: "Meet with a lender to determine your budget and get pre-approved for a mortgage. This shows sellers you're serious and helps you move quickly in competitive markets.",
    duration: "1-2 weeks",
    icon: "💰",
    details: [
      "Choose a local lender familiar with MA transactions",
      "Get pre-approved, not just pre-qualified",
      "Lock in your rate when you find the right home",
    ],
  },
  {
    number: 2,
  ...
  },
  {
    number: 4,
    title: "Make an Offer",
    description: "When you find the right home, your agent will help you craft a competitive offer based on comparable sales and market conditions.",
    duration: "1 day",
    icon: "📝",
    details: [
  ...
  },
  {
    ...
    description: "Hire a professional inspector to evaluate the home's condition. This typically happens within 10 days of acceptance.",
    duration: "1-2 weeks",
    icon: "🔍",
    details: [
  ...
  },
  {
    ...
    description: "Your lender orders an appraisal and reviews your financial documents. This ensures the home value supports the loan amount.",
    duration: "2-3 weeks",
    icon: "📊",
    details: [
  ...
  },
  {
    ...
    description: "Do a final walkthrough 24 hours before closing to confirm all repairs were completed and the home is in agreed-upon condition.",
    duration: "1 day",
    icon: "✅",
    details: [
