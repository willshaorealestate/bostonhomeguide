...
const neighborhoods = [
  { name: "Newton", type: "City", medianPrice: "$1.4M", schools: "A+", img: "/images/towns/newton.jpeg" },
  { name: "Wellesley", type: "Town", medianPrice: "$2.6M", schools: "A+", img: "/images/towns/wellesley.jpeg" },
  { name: "Brookline", type: "Town", medianPrice: "$1.44M", schools: "A", img: "/images/towns/brookline.jpeg" },
  { name: "Natick", type: "Town", medianPrice: "$900K", schools: "A", img: "/images/towns/natick.jpeg" },
  { name: "Lexington", type: "Town", medianPrice: "$1.58M", schools: "A+", img: "/images/towns/lexington.jpeg" },
  { name: "Concord", type: "Town", medianPrice: "$1.42M", schools: "A+", img: "/images/towns/concord.jpeg" },
  { name: "Needham", type: "Town", medianPrice: "$1.7M", schools: "A", img: "/images/towns/needham.jpeg" },
  { name: "Framingham", type: "City", medianPrice: "$675K", schools: "B+", img: "/images/towns/framingham.jpeg" },
];
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm text-gray-500 font-body mt-1">Updated July 2026</p>
            </div>
            <div className="flex flex-wrap gap-6 md:gap-10">
              {[
                { label: "Median Sale Price", value: "$850,000", change: "Jul 2026", up: true },
                { label: "Days on Market", value: "35 days", change: "Greater Boston", up: false },
                { label: "List-to-Sale Ratio", value: "101%", change: "Above asking", up: true },
                { label: "Active Inventory", value: "940", change: "Jul 2026", up: false },
              ].map((metric) => (
